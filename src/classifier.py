'''
    Definition of simple, centralized, classifiers.
    This module defines routines for model selection, training and evaluation of centralized models.
    The architecture of the models is defined in global_models.py.
    HPs are found via model selection. The optimizer is Adam.
    ...
    is not to find the best model ever for the chosen task,
...
from global_models import MNISTModel, FashionMNISTModel
